...
@synthesize errorTimer;
@synthesize requestClassName;
...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    MBView = view;
        ...
        UIView* backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, -10, screenRect.size.width, screenRect.size.height + 10)];
...
+ (BOOL)hideHUDForLastView
{
    MBProgressHUD *hud = [self HUDForView:MBView];
	if (hud != nil) {
...
- (void)layoutSubviews {
	...
	// Using Screen Size to center the HUD
